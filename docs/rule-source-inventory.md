...
This document is a candidate-source inventory for Phase R5.2 sampling design. It does not create the corpus and does not authorize execution-phase collection. Until [PROTOCOL.md Section 9](../PROTOCOL.md#9-protocol-status-phase-r9) reads `LOCKED`, commands in this document are collection recipes only.
