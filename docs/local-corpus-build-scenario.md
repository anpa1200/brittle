...
This document logs the local exploratory workflow used to discover, download, normalize, sort, and clean public detection-rule sources. It is **not** the locked research methodology. The formal sampling and validation method still belongs in [PROTOCOL.md](../PROTOCOL.md), especially Sections 4 and 5.
...
- Existing Phase R1 prior-work survey in [PROTOCOL.md](../PROTOCOL.md#13-prior-work-survey).
- Public GitHub repositories and direct rule-download endpoints.
- Candidate inventory in [rule-source-inventory.md](rule-source-inventory.md).
