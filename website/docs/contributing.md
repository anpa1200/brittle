...
BrittleBench is currently in the **pre-lock protocol review phase** (Phase R9). The research protocol ([PROTOCOL.md](./protocol)) is not yet locked, and no confirmatory execution-phase code or data exists.
...
Once Phase E (execution) begins — that is, once [PROTOCOL.md](./protocol) Section 9.1 reads `LOCKED` — contributions will be welcome in the following areas:
...
All contributors and community members are expected to follow our [Code of Conduct](./code-of-conduct).

---

## Contact

For questions about the project before contributions open, contact the author via GitHub ([@anpa1200](https://github.com/anpa1200)) or at 1200km@gmail.com.
