...
This document turns the locked protocol into the first execution step. It does not change [Protocol](./protocol); it operationalizes the mandatory feasibility pilot required by Sections 5.1, 5.2, 5.7, 5.8, and 9.3.
