...
Once Phase E (execution) begins — that is, once [PROTOCOL.md](PROTOCOL.md) Section 9.1 reads `LOCKED` — contributions will be welcome in the following areas:
...
All contributors and community members are expected to follow our [Code of Conduct](CODE_OF_CONDUCT.md).
